<template>
    <div class="editor">
        <h1>发布每日一句</h1>
        <p>
            <input type="text" disabled name="title" placeholder="请输入标题">
            <input type="text" disabled name="tag" placeholder="请输入标签，用逗号隔开">
...
<script>
    export default {
        ...
        methods: {
            sendContent(){
                // 发布每日一句
                this.$axios.post("/api/editEveryDay", this.editorContent)
